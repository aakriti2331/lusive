...
$config['csrf_exclude_uris'] 	= array('home/paypal_success',
                                    ...
                                    'home/repair_modal',
                                    'home/return_url',
                                    'home/success_payments',
                                    'home/failed_payments',
                                    'home/get_curl_handle',
                                    ...
                                    'api/country_get',
                                    'api/slider',
                                    'api/slider_by_product/{id}/{start}',
                                    'api/categories',
                                    'api/sociallogin',
                                    'api/edit_profile',
                                    'api/update_verification',
                                    'api/best_seller',
                                    'api/trending',
                                    'api/categories_by_id',
                                    'api/mobile',
                                    'api/computer',
                                    'api/electronics',
                                    'api/userdetails',
                                    ...
                                    'api/product_star',
                                    'api/search_product',
                                    'api/search_by_suggestion',
                                    'api/banner',
                                    'api/cash_on_delivery',
                                    'api/order_create',
                                    'api/razorpay',
                                    'api/get_notification',
                                    'api/readby_notification',
                                    'api/report_problem',
                                    'api/change_passwordapi',
                                    'api/getProductList',
