...
class Crud_model extends CI_Model
{
    ...
    public function selectjoin($tbl,$con='',$con1='',$con2='',$con3='')
    {
        $this->db->select('*');    
        $this->db->from($tbl);
        $this->db->join('vendor', 'business_settings.vendorid = vendor.vendor_id');
        $this->db->where($con);
    ...
    function vendor_share_total($vendor_id, $pay = '', $pay_type = '')
    {
        ...
        $shipping = 0;
        $total = 0;
        $commission = $this->db->get_where('business_settings', array('type' => 'commission_amount','vendorid'=>$vendor_id))->row()->value;
        $sales = $this->db->get('sale')->result_array();
        foreach ($sales as $row) {
