    ...
    <div id="page-content">
        ...
        <div class="row" <?php if($this->crud_model->get_type_name_by_id('general_settings','68','value') == 'ok'){}else{ ?>style="display:none;"<?php } ?> >
            <div class="col-md-4 col-lg-4">
                <div class="panel panel-bordered panel-redd">
                    ...
                    <div class="panel-body">
                        <div class="text-center">
                          ...
                          <div style="display:none"> <canvas id="gauge1" height="70" class="canvas-responsive"></canvas> </div>
                            <p class="h4">
                                <span class="label label-redd"><?php $user = $this->crud_model->select('user');  echo count($user);?></span>
                                <span id="gauge1-txt" class="label label-redd d-none">0</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="panel panel-bordered panel-bluee">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <p class="h4">
                                <span class="label label-bluee"><?php echo currency('','def');?> <?php $this->db->select_sum('grand_total');
$result = $this->db->get('sale')->row();   echo number_format($result->grand_total,2);
                                //echo $this->db->last_query(); echo count($user);?></span>
                                <span id="gauge2-txt" class="label label-bluee d-none">0</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="panel panel-bordered panel-redd">
                    <div class="panel-heading">
                        <h3 class="panel-title">Total Users Review</h3>
                    </div>
                    <div class="panel-body">
                        <div class="text-center">
                        <i class="fa fa-star fa-5x" aria-hidden="true"></i>
                          <div style="display:none"> <canvas id="gauge1" height="70" class="canvas-responsive"></canvas> </div>
                            <p class="h4">
                                <span class="label label-redd">0</span>
                                <span id="gauge3-txt" class="label label-redd d-none">0</span>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row" <?php if($this->crud_model->get_type_name_by_id('general_settings','58','value') == 'ok'){}else{ ?>style="display:none;"<?php } ?> >
            <div class="col-md-4 col-lg-4">
                <div class="panel panel-bordered panel-redd" style="height:205px;">
                    <div class="panel-heading">
                ...
                <div class="panel panel-bordered panel-bluee" style="height:205px;">
                    <div class="panel-heading">
