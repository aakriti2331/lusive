        ...
        <div class="col-sm-12">
            <div class="panel-body">
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <tr>
                        <th class="custom_td"><?php echo translate('password');?></th>
                        <td class="custom_td"><?php echo $row['password_show']?></td>
                    </tr>
                    <tr>
                        <th class="custom_td"><?php echo translate('gstno');?></th>
                        <td class="custom_td"><?php echo $row['gstno']?></td>
                    </tr>
                    <tr>
                        <th class="custom_td"><?php echo translate('license');?></th>
                        <td class="custom_td"><?php echo $row['license']?></td>
                    </tr>
                    <tr>
                        <th class="custom_td"><?php echo translate('adharimg');?></th>
                        <td class="custom_td"><a href="<?php echo base_url(); ?>kyc/<?php echo $row['adharimg']?>" download><img src="<?php echo base_url(); ?>kyc/<?php echo $row['adharimg']?>" alt="" style="width: 90px; height:51px;float: left;"></a></td>
                    </tr>
                    <tr>
                        <th class="custom_td"><?php echo translate('pancardimg');?></th>
                        <td class="custom_td"><a href="<?php echo base_url(); ?>kyc/<?php echo $row['pancardimg']?>" download><img src="<?php echo base_url(); ?>kyc/<?php echo $row['pancardimg']?>" alt="" style="width: 90px; height:51px;float: left;"></a></td>
                    </tr>
                    <?php if($row['skype'] != ''){ ?>
                    <tr>
