        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                $vendorid=$this->session->userdata('vendor_id');
                 if ($this->db->get_where('business_settings',array('type' => 'commission_set'))->row()->value == 'yes') {?>
                <div class="col-md-4 col-lg-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <tr>
                                            ...
                                            <td><?php 
                                            $vendorprice=$this->db->get_where('business_settings',array('type' => 'commission_amount','vendorid'=>$vendorid))->row()->value;
                                            ...
                                            {
                                                echo $this->db->get_where('business_settings',array('type' => 'commission_amount','vendorid'=>null))->row()->value;
                                            }
                                            ?>
                                           % </td>
                                        </tr>
