                    ...
                    <div class="tab-pane fade active in" id="" style="border:1px solid #ebebeb; border-radius:4px;">
                        ...
                        ?>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-4">
                                        <?php echo translate('gst_no');?>
                                            </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="gstno" value="<?php echo $row['gstno']; ?>" id="demo-hor-4" class="form-control address" onblur="set_cart_map('iio');" pattern="[0-9]*" maxlength="15" minlength="15" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-4">
                                        <?php echo translate('licence');?>
                                            </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="licence" value="<?php echo $row['licence']; ?>" id="demo-hor-4" class="form-control address" onblur="set_cart_map('iio');" pattern="[0-9]*" maxlength="15" minlength="15" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-4">
                                        <?php echo translate('aadhar');?>
                                            </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="adhar" value="<?php echo $row['adhar']; ?>" id="demo-hor-4" class="form-control address" onblur="set_cart_map('iio');" pattern="[0-9]*" maxlength="12" minlength="12" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-4">
                                        <?php echo translate('aadhar_image');?>
                                            </label>
                                    <div class="col-sm-6">
                                        <input type="file" name="adharimg" id="demo-hor-4" class="form-control address" onblur="set_cart_map('iio');">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-4">
                                        <?php echo translate('pancard');?>
                                            </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="pancard" value="<?php echo $row['pancard']; ?>" id="demo-hor-4" class="form-control address" onblur="set_cart_map('iio');" pattern="[0-9a-zA-Z]*" maxlength="10" minlength="10" oninput="this.value = this.value.replace(/[^0-9a-zA-Z]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="demo-hor-4">
                                        <?php echo translate('pancard_image');?>
                                            </label>
                                    <div class="col-sm-6">
                                        <input type="file" name="pancardimg" id="demo-hor-4" class="form-control address" onblur="set_cart_map('iio');">
                                    </div>
                                </div>
