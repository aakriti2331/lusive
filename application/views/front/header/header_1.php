        ...
        <div class="container">
            ...
            <nav class="navigation closed clearfix">
                ...
                <ul class="nav sf-menu">
					...
					?>
                    <?php if($this->db->get_where('ui_settings',array('type'=>'repair'))->row()->value == 'yes') {?>
                    <li <?php if($asset_page=='repair'){ ?>class="active"<?php } ?>>
                        <a href="<?php echo base_url(); ?>home/repair">
                            <?php echo translate('Repair_My_Product');?>
                        </a>
                    </li>
                    <?php } ?>
