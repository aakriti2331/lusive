...
?>
<label class="radio-inline"><input type="radio" value="cash_on_delivery" name="payment_type" checked> Cash on delivery </label>
    <label class="radio-inline"><input type="radio" value="online" name="payment_type">Pay Online</label>
<div class="row ">
    <div class="col-md-6">
