            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                ?>
                	<div class="row box_shape">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control" pattern="[0-9]*" maxlength="10" minlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" name="phone" type="text" placeholder="<?php echo translate('phone');?>" data-toggle="tooltip" title="<?php echo translate('phone');?>">
                            </div>
                        </div>
