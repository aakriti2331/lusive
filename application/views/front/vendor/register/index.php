            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                ?>
                	<div class="row box_shape">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <lebal>Aadhar image</lebal>
                                <input class="form-control required" name="adharimg" type="file" placeholder="<?php echo translate('aadhar_image');?>" data-toggle="tooltip" title="<?php echo translate('aadhar_image');?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <lebal>Pancard image</lebal>
                                <input class="form-control required" name="pancardimg" type="file" placeholder="<?php echo translate('pancard_image');?>" data-toggle="tooltip" title="<?php echo translate('pancard_image');?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control required" name="gstno" type="text" placeholder="<?php echo translate('gst_no');?>" data-toggle="tooltip" title="<?php echo translate('gst_no');?>" pattern="[0-9a-zA-Z]*" maxlength="15" minlength="15" oninput="this.value = this.value.replace(/[^0-9a-zA-Z]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control required" name="licence" type="text" placeholder="<?php echo translate('licence_no');?>" data-toggle="tooltip" title="<?php echo translate('licence_no');?>" pattern="[0-9a-zA-Z]*" maxlength="15" minlength="15" oninput="this.value = this.value.replace(/[^0-9a-zA-Z]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');">
                            </div>
                        </div>
